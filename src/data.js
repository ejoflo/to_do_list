...
const initList = (function() {   // initializes app with a default list
    ...
    masterList.listArray[0].items = masterList.listArray[0].addItem(itemFactory('To add a list item, click the + button.', 'This line is where you can add notes.', `${currentDate.getMonth()+1}/${currentDate.getDate()}/19`, false));
    ...
    let evenMoreBuyInfo = itemFactory('Soft Soap', 'Get the melon scented one', '10/25/19', true, false);
    ...
    masterList.listArray[3].items = masterList.listArray[3].addItem(itemFactory('Check out music venue', 'Find out what bands are playing', '7/21/19', true, false));
    ...
    masterList.listArray[3].items = masterList.listArray[3].addItem(itemFactory('Visit the old landmark', 'Located by the dog park', '7/23/19', true, false));
    ...
    masterList.listArray[3].items = masterList.listArray[3].addItem(itemFactory('Try the artisan coffee', 'Jacob said to get the nitro brew. If Janet is working, ask her for the ultra craft cold brew.', '7/25/19', true, false));
